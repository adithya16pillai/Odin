...
## TODOs & Missing Files
- [ ] Fill in `Gemfile`, `Cargo.toml`, and `package.json` with actual dependencies
- [ ] Implement and document GraphQL mutations in `odin/api/app/graphql/mutations/`
- [ ] Add setup instructions for database and environment variables
- [ ] Add deployment and integration instructions
- [ ] Add example queries/mutations and SDK usage
